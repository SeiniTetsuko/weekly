...
def fallback_rollup_analyze_batch(batch_state):
        ...
        for section_name, entries in (project.get("sections", {}) or {}).items():
            for entry in entries or []:
                ...
                for item in entry.get("items", []) or []:
                    ...
                    target_map = None
                    if section_name == "progress" and (is_completion or is_important):
                    ...
                    if is_important:
                        ...
                        core_candidates.append({
                            ...
                            "important": True,
                            "important_evidence": [item_text[:120]],
    ...
    result["main_progress"] = map_to_items(leaf_progress_map, max_len=500)
